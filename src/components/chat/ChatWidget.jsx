            ...
            <AnimatePresence>
                {isOpen ? (
                    <motion.div
                        ...
                        className="w-[380px] h-[550px] bg-black border-2 border-zinc-900 rounded-[3rem] shadow-[0_40px_100px_rgba(0,0,0,0.9)] flex flex-col overflow-hidden backdrop-blur-3xl relative"
                    >
                        {/* Status Bar */}
                        <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-primary-500 to-secondary-600" />

                        {/* Header */}
                        <div className="p-8 bg-zinc-950/80 border-b border-white/5 flex items-center justify-between">
                        ...
                        {/* Messages Area */}
                        <div ref={scrollRef} className="flex-grow p-8 overflow-y-auto space-y-6 scrollbar-none bg-[url('https://www.transparenttextures.com/patterns/carbon-fibre.png')] bg-fixed opacity-95">
                            {messages.map((msg) => {
                                ...
                                return (
                                    ...
                                    >
                                        <div className={`max-w-[85%] p-5 rounded-[2rem] text-sm font-bold italic tracking-tight relative ${isMe
                        ...
                        <form onSubmit={handleSend} className="p-8 bg-zinc-950/90 border-t border-white/5 flex gap-4 backdrop-blur-xl">
                            <input
                                type="text"
                                value={newMessage}
                            ...
                            <button
                                ...
                                className="w-14 h-14 bg-primary-500 hover:bg-primary-400 rounded-full text-black transition-all disabled:opacity-30 disabled:grayscale flex items-center justify-center shadow-xl shadow-primary-500/20"
                            >
                    ...
                    <motion.div className="relative">
                        <motion.button
                            ...
                            className="w-20 h-20 bg-primary-500 text-black rounded-[2rem] shadow-[0_20px_60px_rgba(245,158,11,0.4)] flex items-center justify-center relative group"
                        >
                            <MessageSquare className="w-10 h-10" />
                            <div className="absolute -top-2 -right-2 w-7 h-7 bg-black border-4 border-primary-500 rounded-full flex items-center justify-center">
